...
SECRET_KEY = 'django-insecure-fsk4=u2+z(2keq=4+9huaht0jbor#qv+=zyjs4-=9y)81)73_&'
...
STATIC_URL = 'static/'
MEDIA_ROOT = Path(BASE_DIR,'media') #path to a directory where django uploads the files
MEDIA_URL = '/media/'
